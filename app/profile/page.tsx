...
export default function ProfilePage() {
  ...
  useEffect(() => {
    ...
    $api.get(`${API_URL}/notification/count`).then((res) => {
            ...
            <div className="md:w-64 space-y-6">
              <div className="flex flex-col items-center text-center p-6 border rounded-lg">
                <Avatar className="h-24 w-24 mb-4">
                  <AvatarImage alt={`${user.fio}`} />
                  <AvatarFallback>
                    {user.fio.charAt(0)}
                    {user.fio.charAt(0)}
                  </AvatarFallback>
                </Avatar>
                <h2 className="text-xl font-bold">{user.fio}</h2>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        от{" "}
                        {new Date(
                          selectedOrder.createdAt as string
                        ).toLocaleDateString("ru-RU", {
                          day: "2-digit",
                          month: "2-digit",
                          year: "numeric", // Полный год
                  ...
                  <Card>
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between text-sm">
                          ...
                          <span>
                            {(
                              selectedOrder.summa -
                              (selectedOrder.delivery?.deliverySum || 0)
                            ).toLocaleString()}
                            ₽
                          </span>
                        </div>
                        <div className="flex justify-between text-sm">
                          ...
                          {selectedOrder.delivery ? (
                            <span>{selectedOrder.delivery.deliverySum} ₽</span>
                          ) : (
                            <span>0 ₽</span>
                          )}
                        </div>
                    ...
                    <CardFooter className="flex justify-between">
                      ...
                      {selectedOrder.status === "pending" && (
                        <Button onClick={() => {
                          $api.delete(`${API_URL}/orders?orderId=${selectedOrder.id}`).then().catch()
